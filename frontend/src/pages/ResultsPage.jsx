    ...
    return (
        <div className="rounded-xl bg-[#E85F00]/10 border border-[#E85F00]/30 px-4 py-3 flex items-center gap-3 min-w-[160px]">
            ...
            <div>
                ...
                <div className="text-[10px] uppercase tracking-[0.18em] text-ink-3 mt-1">{d.label}</div>
            </div>
        </div>
    );
};
                            ...
                            >
                                ...
                                <div className="px-5 sm:px-8 py-5 border-b border-white/8 flex items-center justify-between gap-3 flex-wrap">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-[11px] uppercase tracking-[0.22em] text-ink-3">Story {String(idx + 1).padStart(2, '0')}</div>
                                            <h2 className="font-display text-xl sm:text-2xl font-bold text-white leading-tight">{s.role}</h2>
                                        </div>
                                    </div>
                                ...
                                <div className="relative grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/8">
                                    ...
                                    <div className="p-5 sm:p-8">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs uppercase tracking-[0.22em] text-rose-300">Before</span>
                                        </div>
                                    ...
                                    <div className="p-5 sm:p-8">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs uppercase tracking-[0.22em] text-emerald-300">After</span>
                                        </div>
                                ...
                                <div className="px-5 sm:px-8 py-5 border-t border-white/8 bg-[#070C1F]">
                                    <div className="flex items-center gap-3 mb-3">
                                        <div className="text-[11px] uppercase tracking-[0.22em] text-[#FF7A1A]">The shift</div>
                                        <span className="h-px flex-1 bg-white/8" />
                                    </div>
                                    <div className="flex flex-wrap gap-3">
                                        {s.deltas.map((d) => <DeltaPill key={d.label} d={d} />)}
                                    </div>
                                </div>
                            </motion.article>
                        );
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                            ...
                            <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3">
                                <Link to="/courses" className="sm:flex-1">
                                    <button type="button" className="w-full h-12 inline-flex items-center justify-center gap-2 bg-[#E85F00] hover:bg-[#FF7A1A] text-white rounded-xl font-semibold btn-orange-glow">
